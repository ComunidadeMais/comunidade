export const TINYMCE_CONFIG = {
  apiKey: '6es0dm48050c17kbmdwa79iet0uli50k5fbooesik6o0q6g7',
  default_init: {
    height: 500,
    menubar: true,
    ...
    content_templates: [
      {
        title: 'Template padrão para eventos da comunidade',
        description: 'Template padrão para eventos da comunidade',
